...
async def next_page(bot, query):
    ...
    if settings['button']:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}] ⊳ {file.file_name}", url=f'https://t.me/MCU_Salim_kumar_bot?start=files_{file.file_id}'
                ),
            ]
            for file in files
        ]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    text=f"{file.file_name}", url=f'https://t.me/MCU_Salim_kumar_bot?start=files_{file.file_id}'
                ),
                InlineKeyboardButton(
        ...
        btn = [
            [
                InlineKeyboardButton(
                    ...
                    url=f'https://t.me/MCU_Salim_kumar_bot?start=files_{file.file_id}',
                ),
                InlineKeyboardButton(
                    text=f"{get_size(file.file_size)}",
                    url=f'https://t.me/MCU_Salim_kumar_bot?start=files_{file.file_id}',
